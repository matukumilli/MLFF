...
The goal of this repository is to **facilitate reproducibility, transparency, and reuse** of the MLFF data and workflows developed in my research.

Additional details about individual datasets and scripts can be found in the corresponding subdirectories.
